_LIBC_ARCH_COMMON_SRC_FILES += \
    arch-x86/x86-atom/string/sse2-bzero-atom.S \
    ...
    arch-x86/x86-atom/string/sse2-memset-atom.S \
    arch-x86/x86-atom/string/sse2-strchr-atom.S \
    arch-x86/x86-atom/string/sse2-strlen-atom.S \
    ...
    arch-x86/x86-atom/string/ssse3-bcopy-atom.S \
    arch-x86/x86-atom/string/ssse3-memcmp-atom.S \
    arch-x86/x86-atom/string/ssse3-memcmp16-atom.S \
    arch-x86/x86-atom/string/ssse3-memcpy-atom.S \
    arch-x86/x86-atom/string/ssse3-memmove-atom.S \
    arch-x86/x86-atom/string/ssse3-strcat-atom.S \
    arch-x86/x86-atom/string/ssse3-strcmp-atom.S \
    arch-x86/x86-atom/string/ssse3-strcpy-atom.S \
    ...
    arch-x86/x86-atom/string/ssse3-strncpy-atom.S \
    arch-x86/x86-atom/string/ssse3-wcscat-atom.S \
    arch-x86/x86-atom/string/ssse3-wcscpy-atom.S \
    arch-x86/x86-atom/string/ssse3-wmemcmp-atom.S
